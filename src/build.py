...
PARTS = [
    ...
    ("第六部 · 實戰專題 C：累計心得（15_累計心得）",
     [("ch06-9", None), ("ch06-10", None), ("ch06-11", None), ("ch06-12", None), ("ch06-13", None)]),
    ...
    ("第十部 · S/4HANA 新世代開發：CDS、AMDP、RAP",
     [("ch10-1", None), ("ch10-2", None), ("ch10-3", None), ("ch10-4", None), ("ch10-5", None)]),
    ("附錄", [("ap-01", None)]),
]
